...
class DoublyLL08
{
    public static void main(String A[])
    {
        ...
        System.out.println("Before InsertAtPos()");
        dobj.Display();
        System.out.println("Number of Nodes : " + dobj.Count());

        dobj.InsertAtPos(105,4);

        System.out.println("After InsertAtPos()");
        dobj.Display();
        System.out.println("Number of Nodes : " + dobj.Count());
    }
}
...
Program 008 demonstrates the InsertAtPos() operation in a Doubly Linear
Linked List using Java. It inserts a new node at the desired position
while maintaining the integrity of the previous and next links.
